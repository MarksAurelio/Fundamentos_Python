...
c0 = int(input("Digite um número natural diferente de zero: "))
steps = 0
print("Valor inicial de c0:", c0)
while c0 != 1:
    if c0 % 2 == 0:
        c0 = c0 // 2
    else:
        c0 = 3 * c0 + 1
    steps += 1
    print("Valor atual de c0:", c0)
print("Número total de etapas para atingir 1:", steps)
